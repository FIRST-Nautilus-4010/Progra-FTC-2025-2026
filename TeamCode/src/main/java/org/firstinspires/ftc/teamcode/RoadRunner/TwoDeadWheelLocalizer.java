...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -8903.823846094969; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -6955.186273058784; // x position of the perpendicular encoder (in tick units)
    }
